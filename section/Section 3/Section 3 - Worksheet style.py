...
# # Welcome to week 3!
# 
# _You can find this notebook (and a plain .py file version) on my GitHub repo: http://github.com/obnorthrup/144coursework _  
# _It'll go up on the main course site tomorrow._
# 
# #### Plan
# 
# - Dictionaries
